...
(function () {
  ...
  var CSS = [
    ...
    '.t785-error { margin-top: 12px; padding: 10px 14px; background: #2e0a15; border: 1px solid rgba(200,6,80,0.4); border-radius: 8px; font-size: 13px; color: #ff6b93; }',
    ...
    '.t785-addon-row { padding: 10px; border-radius: 8px; border: 1.5px solid #ece8e2; background: #ffffff !important; cursor: pointer; }',
    '.t785-addon-row:hover { border-color: #d8d3cc; }',
    '.t785-addon-row.selected { border-color: #C80650; background: #ffffff !important; }',
    ...
    '.t785-addon-name { font-size: 14px; color: #1a1814 !important; font-weight: 600; }',
    ...
    '.t785-table-addon-choice-label { font-size: 13px; color: #1a1814 !important; flex: 1; }',
