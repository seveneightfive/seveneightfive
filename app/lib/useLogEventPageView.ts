...
/**
 * Call this hook in your public event page to log page views with traffic source detection.
 * 
 * Usage:
 * ```tsx
 * export default function EventPage({ params }: { params: { slug: string } }) {
 *   useLogEventPageView(params.slug)
 *   // ... rest of your page
 * }
 * ```
 */
export function useLogEventPageView(eventSlug: string) {
  useEffect(() => {
