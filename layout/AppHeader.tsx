 ...
 *
 * Departures from TailAdmin's stock AppHeader:
 *  - Right-side UserDropdown replaced with the 785 AvatarMenu (which is
 *    already in app/dashboard/ from your existing build).
 *  - NotificationDropdown left commented out until you have a notifications
 *    schema. Re-enable by uncommenting the import + JSX.
 *  - Logo paths fixed from "./images/logo/..." → "/images/logo/..." (the
 *    leading "./" broke the path on routes nested below `/`).
 *  - Guest (signed-out) view renders Sign In / Sign Up Free buttons in place
 *    of the avatar, mirroring the topbar from your previous dashboard.
 */
